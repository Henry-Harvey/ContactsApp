...
public class AddBusinessContact extends AppCompatActivity {
    ...
    Button btn_submit, btn_cancel, btn_loadPhoto, btn_takePhoto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ContactAdapter(AddBusinessContact.this, addressBook.getList());
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((et_country.getText().toString().equals("") || et_zip.getText().toString().equals("") || et_state.getText().toString().equals("") ||
                    ...
                    Toast.makeText(AddBusinessContact.this, "Please enter all fields", Toast.LENGTH_SHORT).show();
                } else {
